package br.com.fernantech.brewer.validation.validator;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object> {
	...
	//para a senha vazia, no caso usado na alteração de usuário onde não é obrigatório atualizar a senha
