...
import br.com.fernantech.brewer.session.TabelaItensVenda;
...
public class TabelaItensVendaTest {
	...
	public void deveManterTamanhoDaListaParaMesmasCervejas() throws Exception {
		...
		c1.setCodigo(1L);
		c1.setValor(new BigDecimal("4.90"));
		
		tabelaItensVenda.adicionarItem(c1, 1);
		tabelaItensVenda.adicionarItem(c1, 1);
		
		assertEquals(1, tabelaItensVenda.total());
		//assertEquals(new BigDecimal("4.90"), tabelaItensVenda.getValorTotal());
	}
