package br.com.fernantech.brewer.storage.s3;
...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "fernantech-brewer";
	...
	public String getUrl(String foto) {
		if(!StringUtils.isEmpty(foto)) {
			return "https://fernantech-brewer.s3-sa-east-1.amazonaws.com/"+foto;
		}
		return null;
	}
