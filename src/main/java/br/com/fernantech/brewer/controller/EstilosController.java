...
import br.com.fernantech.brewer.service.CadastroEstiloService;
...
public class EstilosController {
	...
	@GetMapping
	public ModelAndView pesquisar(EstiloFilter estiloFilter, @PageableDefault(size = 10) Pageable pageable, 
			BindingResult result, HttpServletRequest httpServletRequest) {
		ModelAndView mv = new ModelAndView("estilo/PesquisaEstilos");
		
		PageWrapper<Estilo> paginaWrapper = new PageWrapper<>(this.estilos.filtrar(estiloFilter, pageable), httpServletRequest);
