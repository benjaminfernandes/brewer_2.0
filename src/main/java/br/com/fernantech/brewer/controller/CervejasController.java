...
import br.com.fernantech.brewer.model.Origem;
import br.com.fernantech.brewer.model.Sabor;
...
public class CervejasController {
	...
	@RequestMapping(value = {"/nova", "{\\d+}"}, method = RequestMethod.POST) //{\\d} expressão regular para recer o id ao editar
