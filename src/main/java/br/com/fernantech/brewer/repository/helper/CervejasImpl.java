...
public class CervejasImpl implements CervejasQueries{
	...
	public ValorItensEstoque valorItensEstoque() {
		...
		String jpql = "select new br.com.fernantech.brewer.dto.ValorItensEstoque(sum(valor*quantidadeEstoque), "
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new br.com.fernantech.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
